      ...
      <template #content>
        <div class="p-6 rounded-lg shadow-lg">
          ...
          <ul v-else class="space-y-3 mb-4 max-h-64 overflow-y-auto">
            <li v-for="(item, index) in cart" :key="index" class="flex justify-between text-lg">
          ...
          <UButton label="Clear" color="primary" variant="soft" class="mt-4 w-auto px-2 justify-center" @click="cart=[]"/>
          <UButton label="Checkout" color="primary" variant="soft" class="mt-4 w-auto px-2 justify-center" @click="cart=[]"/>
          </div>
        </div>
      </template>
    </UModal>
